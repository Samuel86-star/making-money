...
def test_scan_sectors_combines_sources():
    with patch("a_stock.a_screen.sector_scan.industry_comparison") as m1, \
         patch("a_stock.a_screen.sector_scan.ths_hot_reason") as m2, \
         patch("a_stock.a_screen.sector_scan.daily_dragon_tiger") as m3:
