...
515650  消费50ETF     13,000  0.981   12,753
300059  东方财富          100  21.279    2,010
159801  芯片ETF广发      200  1.541      327
159915  创业板ETF      1,000  4.215    4,236
─────────────────────────────────────────
股票/ETF 小计                    24,619
现金                             55,319
总资产                           79,938
...
- 2026-06-29 教训(老板扛): 上午盘面吓到, 创业板4.145浅止损割在日内低点, 芯片1.545第二刀偏早, 下午V回踏空~224元. 错在盘中急杀时卖没等反弹. 铁律固化: ETF止损≥3%或破前日低禁<2%, 强势板块减仓留底仓≥30%, 不在日内低点卖. 东财-5.54%虚亏(db成本21.28偏高, 实际≈20.07平), 趋势站上MA20/MA60, 问题不大持有.
- 2026-06-29 工具增强: ① risk_metrics._load_positions 修bug(原只sum buy/add没net reduce, 风险虚高) → 现正确扣减reduce, +1测试, 全套144 passed. ② rules.yaml +2规则: 恒瑞止损-破48(全减200), 159516半导体材料设备ETF回踩≤1.85提醒(纯卡脖子材料+装备链, 近20日+52%抗跌). ③ monitor CANDIDATE_CODES +159516. ④ watchlist +159516.
